...
public class ServiceController {
	...
	@ResponseBody
	public Map<String, String> approve(HttpServletRequest request) throws JsonParseException, JsonMappingException, IOException {
		Map<String, String> resultMap = new HashMap<String, String>();
		resultMap.put("result", "S");
		Map formMap = request.getParameterMap();
		Iterator<String> keys = formMap.keySet().iterator();
		
		String body = keys.next();
		
		Map paramMap = mapper.readValue(body, Map.class);
		
		try {
			String userId = (String) paramMap.get("ID");
			String bizKey = (String) paramMap.get("NO");
			String processCode = (String) paramMap.get("BIZ");
			bpmService.approve(userId, processCode, bizKey, paramMap, request);
		} catch (Exception e) {
	...
	@RequestMapping(value = "/service/get/worklist/{userId}", method = RequestMethod.POST)
	@ResponseBody
	public List<Map<String, Object>> getUserWorklist(@PathVariable String userId) throws Exception {
		
		List<Map<String, Object>> resultList = bpmService.selectWorklistByUserId(userId);
		
		return resultList;
	}
	
	@RequestMapping(value = "/service/get/data/{instId}", method = RequestMethod.POST)
	@ResponseBody
	public Map<String,Object> getWorkData(@PathVariable String instId) throws Exception {
		
		Map<String, Object> resultMap = bpmService.getWorkData(instId);
		
		return resultMap;
	}
	
	@RequestMapping(value = "/service/complete/{userId}/{instId}/{taskId}", method = RequestMethod.POST)
	@ResponseBody
	public Map<String,String> completeTask(@PathVariable String userId, @PathVariable String instId, @PathVariable String taskId, HttpServletRequest request) throws Exception {
		...
		try {
			bpmService.completeWork(userId, instId, taskId, request);
		} catch (Exception e) {
			resultMap.put("result", "F");
		}
	...
	@RequestMapping(value = "/service/reject/{userId}/{instId}/{taskId}", method = RequestMethod.POST)
	@ResponseBody
	public Map<String,String> rejectTask(@PathVariable String userId, @PathVariable String instId, @PathVariable String taskId, HttpServletRequest request) throws Exception {
		...
		try {
			bpmService.rejectWork(userId, instId, taskId, request);
		} catch (Exception e) {
			resultMap.put("result", "F");
		}
